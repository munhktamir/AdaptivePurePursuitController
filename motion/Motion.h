...
enum completionBehavior_e {OVERSHOOT, VIOLATE_MAX_ACCEL, VIOLATE_MAX_ABS_VEL};
...
typedef struct profileFollower {
    ...
    motionProfileGoal_t *goal;
    motionProfileConstraints_t *constraints;
    setpointGenerator_t *setppointGenerator;
    setpoint_t *latestSetpoint;
} profileFollower_t;



motionState_t kInvalidMotionState = {NAN, NAN, NAN, NAN};
